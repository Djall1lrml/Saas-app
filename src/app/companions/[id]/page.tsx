import CompanionComponent from "@/src/components/CompanionComponent";
import { getCompanion } from "@/src/lib/actions/companion.action";
...
const CompanianSession = async ({ params }: CompanionSessionPageProps) => {
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center gap-2">
              ...
              <div className="subject-bagde max-sm:hidden">
                {companion.subject}
              </div>
            </div>
          </div>
